...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.titleTarget.setGeometry(QtCore.QRect(60, -2, 74, 31))
        ...
        self.frameProducts.setMinimumSize(QtCore.QSize(499, 254))
        ...
        self.labelTargetTime.setGeometry(QtCore.QRect(353, 210, 131, 20))
        ...
        self.numRemainTime.setGeometry(QtCore.QRect(360, 120, 74, 31))
        font = QtGui.QFont()
        font.setFamily("FontAwesome")
        font.setPointSize(22)
        font.setBold(False)
        ...
        self.verticalLayout_3.addWidget(self.frameProducts, 0, QtCore.Qt.AlignTop)
        self.frameBroadcast = QtWidgets.QFrame(self.layoutRunning)
        self.frameBroadcast.setMinimumSize(QtCore.QSize(0, 305))
...
"border-radius: 5px;")
        ...
        self.btnStart.setGeometry(QtCore.QRect(120, 120, 221, 41))
...
"}")
        ...
        self.btnHold.setGeometry(QtCore.QRect(30, 180, 151, 41))
        font = QtGui.QFont()
        font.setFamily("Sans")
        font.setPointSize(14)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.titleTarget.setText(_translate("MainWindow", "Target"))
        self.numTarget.setText(_translate("MainWindow", "0/100"))
